...
test.describe('Text Field', () => {
  test('Default', async ({ page }) => {
    ...
    expect(
      await page.locator('jp-text-field').first().screenshot()
    ).toMatchSnapshot('text-field-default.png');
  });
  ...
  test('With Placeholder', async ({ page }) => {
    ...
    expect(
      await page.locator('jp-text-field').first().screenshot()
    ).toMatchSnapshot('text-field-with-placeholder.png');
  });
  ...
  test('With Autofocus', async ({ page }) => {
    ...
    expect(
      await page.locator('jp-text-field').first().screenshot()
    ).toMatchSnapshot('text-field-with-autofocus.png');
  });
  ...
  test('With Disabled', async ({ page }) => {
    ...
    expect(
      await page.locator('jp-text-field').first().screenshot()
    ).toMatchSnapshot('text-field-with-disabled.png');
  });
  ...
  test('With Size', async ({ page }) => {
    ...
    expect(
      await page.locator('jp-text-field').first().screenshot()
    ).toMatchSnapshot('text-field-with-size.png');
  });
  ...
  test('With Type', async ({ page }) => {
    ...
    expect(
      await page.locator('jp-text-field').first().screenshot()
    ).toMatchSnapshot('text-field-with-type.png');
  });
  ...
  test('With Max Length', async ({ page }) => {
    ...
    expect(
      await page.locator('jp-text-field').first().screenshot()
    ).toMatchSnapshot('text-field-with-max-length.png');
  });
  ...
  test('With Readonly', async ({ page }) => {
    ...
    expect(
      await page.locator('jp-text-field').first().screenshot()
    ).toMatchSnapshot('text-field-with-readonly.png');
  });
  ...
  test('With Start Icon', async ({ page }) => {
    ...
    expect(
      await page.locator('jp-text-field').first().screenshot()
    ).toMatchSnapshot('text-field-with-start-icon.png');
  });
});

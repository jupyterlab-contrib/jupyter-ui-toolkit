...
/** @public */
export const controlCornerRadius = create<number>(
...
export const focusStrokeWidth =
  create<number>('focus-stroke-width').withDefault(2);
...
export const neutralColor =
  create<Swatch>('neutral-color').withDefault(middleGrey);
...
export const accentColor =
  create<Swatch>('accent-color').withDefault(accentBase);
...
/** @public */
export const neutralLayer1 = create<Swatch>('neutral-layer-1').withDefault(
  (element: HTMLElement) =>
...
/** @public */
export const neutralLayer2 = create<Swatch>('neutral-layer-2').withDefault(
  (element: HTMLElement) =>
...
/** @public */
export const neutralLayer3 = create<Swatch>('neutral-layer-3').withDefault(
  (element: HTMLElement) =>
...
/** @public */
export const neutralLayer4 = create<Swatch>('neutral-layer-4').withDefault(
  (element: HTMLElement) =>
...
/** @public */
export const accentFillActive = create<Swatch>(
  'accent-fill-active'
).withDefault((element: HTMLElement) => {
...
/** @public */
export const accentForegroundRest = create<Swatch>(
...
/** @public */
export const neutralFillHover = create<Swatch>(
  'neutral-fill-hover'
).withDefault(
  (element: HTMLElement) =>
...
/** @public */
export const neutralFillActive = create<Swatch>(
  'neutral-fill-active'
).withDefault(
  (element: HTMLElement) =>
...
/** @public */
export const neutralFillFocus = create<Swatch>(
  'neutral-fill-focus'
).withDefault(
  (element: HTMLElement) =>
...
/** @public */
export const neutralFillInputRest = create<Swatch>(
...
/** @public */
export const neutralStrokeRest = create<Swatch>(
  'neutral-stroke-rest'
).withDefault(
  (element: HTMLElement) =>
...
/** @public */
export const neutralStrokeHover = create<Swatch>(
...
/** @public */
export const neutralStrokeActive = create<Swatch>(
...
/** @public */
export const neutralStrokeFocus = create<Swatch>(
